...
| `intermissionDuration` | `2` (minimum seconds to show a static loading screen between modes; the screen remains until the next mode's background refresh finishes)
