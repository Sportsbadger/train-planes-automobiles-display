...
def test_adsb_config_parses_enabled_values(monkeypatch):
    ...
    monkeypatch.setenv("intermissionDuration", "3.5")
    ...
    assert config["transport"]["intermissionDuration"] == 3.5
...
def test_intermission_duration_is_at_least_two_seconds(monkeypatch):
