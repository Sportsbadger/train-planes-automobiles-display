...
| `intermissionDuration` | `2` (minimum seconds to show a static loading screen between modes; values below 2 are clamped to 2, and the screen remains until the next mode's background refresh finishes)
